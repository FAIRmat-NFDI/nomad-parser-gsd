...
```sh
git clone https://github.com/FAIRmat-NFDI/nomad-parser-gsd.git
cd nomad-parser-gsd
...
```sh
pip install dist/nomad-parser-gsd-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Bernadette Mohr | [bernadette.mohr@physik.hu-berlin.de](mailto:bernadette.mohr@physik.hu-berlin.de)
